...
const Card = (props: CardProps) => {
    ...
    return  (
        ...
        <li key={props.product.id} className="even:justify-self-end desktop:even:justify-self-auto grid gap-[20px] w-fit">
            ...
            <Link to={'/' + pages.product + '/' + props.product.id} className="grid gap-[20px]">
                ...
                <div className="w-[310px] h-[283px] items-center justify-center bg-bg-cart grid rounded-cart relative">
                    ...
                    <img
                        ...
                        src={new URL(import.meta.env.BASE_URL.slice(0, -1) + props.product.img, import.meta.url).href}
                        alt="product-img"
                    />
