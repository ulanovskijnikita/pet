...
const FavouriteButton = observer((props: FavouriteButtonProps) => {
    ...
    return (
        ...
        <button
            title="to-favourite"
            className="p-[16px] tablet:p-[18px] w-fit! rounded-btn outline-[1px] active:outline-2 outline-[rgba(65,64,62,20)] grid items-center justify-center cursor-pointer"
            onClick={
                () => {
        ...
        >
            ...
            <svg className={`aspect-square w-full block ${props.isFavourite ? 'text-accent' : 'text-main'}`} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
